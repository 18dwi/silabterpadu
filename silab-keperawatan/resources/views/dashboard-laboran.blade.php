<x-app-layout>
    ...
    <div class="py-10 bg-gray-50 min-h-screen" 
         x-data="{ 
             activeTab: localStorage.getItem('laboranActiveTab') || 'inventaris_alat', 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="w-full md:w-64 flex-shrink-0">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-5 flex flex-col items-center text-center space-y-4 sticky top-6">
                        ...
                        <div class="w-full space-y-2.5 pt-4 border-t border-gray-100">
                            ...
                            <!-- Inventaris Lab option -->
                            <!-- Inventaris Lab option -->
                            <button 
                                @click="activeTab = 'inventaris_alat'"
                                :class="activeTab.startsWith('inventaris_') ? 'bg-teal-600 text-white font-semibold shadow-md ring-1 ring-teal-500' : 'bg-white text-gray-700 hover:bg-slate-50 border border-slate-200'"
                ...
                <div class="flex-grow">
                    ...
                    <!-- Group 1: Submenus for Inventaris Lab -->
                    <div x-show="activeTab.startsWith('inventaris_')" class="flex flex-wrap gap-2 mb-6 bg-gray-200/40 p-1 rounded-md max-w-max border border-gray-200" x-transition>
                        <button 
                            @click="activeTab = 'inventaris_alat'"
                            :class="activeTab === 'inventaris_alat' ? 'bg-teal-605 bg-teal-600 text-white font-semibold shadow-sm' : 'bg-white text-gray-650 hover:bg-white/80'"
                            class="px-4 py-2 rounded-md text-xs transition-all duration-150"
                        >
                            Inventaris Alat
                        </button>
                        <button 
                            @click="activeTab = 'inventaris_bahan'"
                            :class="activeTab === 'inventaris_bahan' ? 'bg-teal-605 bg-teal-600 text-white font-semibold shadow-sm' : 'bg-white text-gray-650 hover:bg-white/80'"
                            class="px-4 py-2 rounded-md text-xs transition-all duration-150"
                        >
                            Inventaris Bahan
                        </button>

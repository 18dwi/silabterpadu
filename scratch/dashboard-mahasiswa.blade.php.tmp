                                                             ...
                                                             <div class="relative">
                                                                 ...
                                                                 <div x-show="isOpen" 
                                                                     ...
                                                                     <div class="py-1">
                                                                         ...
                                                                         <template x-for="dbPkg in allPackages.filter(p => !pkg.search || p.nama_paket.toLowerCase().includes(pkg.search.toLowerCase()) || (p.deskripsi && p.deskripsi.toLowerCase().includes(pkg.search.toLowerCase())))" :key="dbPkg.id">
                                                ...
                                                <tr class="hover:bg-slate-50/40 transition-colors duration-150">
                                                    ...
                                                    <td class="px-4 py-4 text-center">
                                                        @if($tx->tipe === 'peminjaman_alat')
                                                            <div class="text-slate-700 font-semibold">Pinjam: {{ $tx->tanggal_pinjam ? $tx->tanggal_pinjam->format('d-m-Y H:i') : '-' }}</div>
                                                            <div class="text-[10px] text-red-500 font-semibold mt-1">Rencana: {{ $tx->tanggal_kembali_rencana ? $tx->tanggal_kembali_rencana->format('d-m-Y H:i') : '-' }}</div>
                                                        @else
